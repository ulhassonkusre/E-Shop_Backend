...
public class ProductService : IProductService
{
    ...
    private void SeedProducts()
    {
        var sampleProducts = new[]
        {
            ...
            new Product { Name = "Mechanical Keyboard", Description = "RGB mechanical gaming keyboard with Cherry MX switches.", Price = 129.99m, ImageUrl = "https://images.unsplash.com/photo-1511467687858-23d96c32e4ae", Stock = 45, Category = "Electronics" },
            ...
            new Product { Name = "Webcam HD", Description = "1080p HD webcam with built-in microphone.", Price = 89.99m, ImageUrl = "https://images.unsplash.com/photo-1511467687858-23d96c32e4ae", Stock = 40, Category = "Electronics" },
            new Product { Name = "Desk Lamp", Description = "LED desk lamp with adjustable brightness and color temperature.", Price = 44.99m, ImageUrl = "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400", Stock = 55, Category = "Home" },
            ...
            new Product { Name = "Cable Organizer", Description = "Desktop cable management system.", Price = 24.99m, ImageUrl = "https://images.unsplash.com/photo-1610557892470-55d9e80c0bce", Stock = 90, Category = "Accessories" }
        };
